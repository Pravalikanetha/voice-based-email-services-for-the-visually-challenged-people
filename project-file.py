...
#project: Project: Voice based Email for Visually Challenged People
#fetch project name
tts = gTTS(text="Project: Voice based Email for visually challenged",
lang='en')
ttsname=("name.mp3") #Example: path -> C:\Users\Akash\Desktop> just
change with your desktop directory. Don't use my directory.
tts.save(ttsname)
...
ttsname=("hello.mp3") #Example: path -> C:\Users\Akash\Desktop> just
change with your desktop directory. Don't use my directory.
tts.save(ttsname)
music = pyglet.media.load(ttsname, streaming = False)
music.play()
...
ttsname=("hello.mp3") #Example: path -> C:\Users\sayak\Desktop> just
change with your desktop directory. Don't use my directory.
tts.save(ttsname)
music = pyglet.media.load(ttsname, streaming = False)
music.play()
...
service; {0}".format(e))
 ...
 mail.ehlo() #Hostname to send for this command defaults to the FQDN of
the local host.
 mail.starttls() #security connection
 mail.login('mnrcet123@gmail.com','jphusrjtjlyaerkp') #login part
mail.sendmail('vajraxxxxxxxxx@gmail.com','vajraxxxxxxxx@gmail.com',msg)
#send part
 print ("Congrates! Your mail has send. ")
 tts = gTTS(text="Congrates! Your mail has send. ", lang='en')
 ttsname=("send.mp3") #Example: path -> C:\Users\sayak\Desktop> just
change with your desktop directory. Don't use my directory.
 tts.save(ttsname)
 music = pyglet.media.load(ttsname, streaming = False)
 music.play()
...
if text == '2' or text == 'tu' or text == 'two' or text == 'Tu' or text == 'to' or
text == 'To' :
 mail = imaplib.IMAP4_SSL('imap.gmail.com',993) #this is host and port
area.... ssl security
 unm = ('mnrcet123@gmail.com') #username
 psw = ('jphusrjtjlyaerkp') #password
mail.login(unm,psw) #login
 ...
 ttsname=("total.mp3") #Example: path -> C:\Users\sayak\Desktop> just
change with your desktop directory. Don't use my directory.
 tts.save(ttsname)
 music = pyglet.media.load(ttsname, streaming = False)
 music.play()
 ...
 ttsname=("unseen.mp3") #Example: path -> C:\Users\sayak\Desktop>
just change with your desktop directory. Don't use my directory.
 tts.save(ttsname)
 music = pyglet.media.load(ttsname, streaming = False)
music.play()
 time.sleep(music.duration)
...
"+str(email_message['Subject']), lang='en')
 ttsname=("mail.mp3") #Example: path -> C:\Users\Akash\Desktop> just
change with your desktop directory. Don't use my directory.
tts.save(ttsname)
 music = pyglet.media.load(ttsname, streaming = False)
 music.play()
...
#Body part of mails:
 ...
 ttsname=("body.mp3") #Example: path -> C:\Users\Akash\Desktop> just
change with your desktop directory. Don't use my directory.
 tts.save(ttsname)
music = pyglet.media.load(ttsname, streaming = False)
 music.play()
